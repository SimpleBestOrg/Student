  ...
  <div class="wrap">
    <div class="content" style="margin-right:0">
      <div class="fly-tab">
        ...
        <a href="questiondetail.jsp" class="layui-btn jie-add">发表问题</a>
      </div>
      <ul class="fly-list">
      ...
      <c:forEach var="s" items="${stuquestion}">
        <li class="fly-list-li">
          ...
          <h2 class="fly-tip">
            <a href="jie/detail.html"><c:out value="${s.question_Content}"></c:out></a>
          ...
          <p>
            ...
            <span class="fly-list-hint"> 
              <i class="iconfont" title="赞">&#xe60c;</i>赞 ${s.question_praise}
              <i class="iconfont" title="踩">&#xe60b;</i>踩 ${s.question_step}
            </span>
          </p>
        </li>
      </c:forEach>
