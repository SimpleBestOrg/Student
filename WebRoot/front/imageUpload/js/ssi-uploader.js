...
(function (root, factory) {
    ...
    Ssi_upload.prototype.init = function (element) {
        ...
        var $chooseBtn = $('' +
         ...
         '<button class="ssi-button success " style="display:none;">' + this.language.chooseFiles + '</button>' +
         '</span>').append(element);
        var $uploadBtn = $('<button id="ssi-uploadBtn" style="display:none;" class="ssi-button success ssi-hidden" >' +
         '<span class="ssi-btnIn">' + this.language.upload + '&nbsp;</span>' +
         '<div id="ssi-up_loading" class="ssi-btnIn"></div></button>');
        var $clearBtn = $('<button id="ssi-clearBtn" style="display:none;" class="ssi-hidden ssi-button info" >' + this.language.clear +
         '</button>');
            ...
            if (thisS.options.preview) {
                ...
                if (fileType[0] == 'image') {
                    ...
                    fileReader.onload = function () {
                        imgContent += getTemplate('<img class="ssi-imgToUpload" style="width:140px;height:128px;" src=""/><i class="fa-spin fa fa-spinner fa-pulse"></i>'); // set the files element without the img
